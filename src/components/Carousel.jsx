...
const Card =(props)=>{
    return (
        <>
        <div className="w-3/4 mx-auto h-30 px-2 shadow-transparent shadow-lg">
            <a href="/"><img className="w-full h-full rounded-xl"
             src={props.src}
             alt="entertainment image" />  </a>
        </div>
        </>
    );
};
...
const CardSlider=()=>{
    const ImageArray =      ["https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:ote-OTUrIEV2ZW50cw%3D%3D,otc-FFFFFF,otf-Roboto,ots-64,ox-48,oy-320,ott-b:w-300:q-80/workshop-and-more-web-collection-202211140440.png",
