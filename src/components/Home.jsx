  ...
  return ( 
    <div name='home' className="w-full h-screen bg-[#107c91]">
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full pl-24 ">
            ...
            <div className="">
            <Link  to="works" smooth={true}  duration={500} > <a href="/" className="relative inline-flex items-center  justify-center p-4 px-6 py-3 overflow-hidden font-bold text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
