...
<span className="absolute flex items-center justify-center w-full h-full text-purple-500 transition-all duration-300 transform group-hover:translate-x-full ease">View Works</span>
<span className="relative invisible">View Works</span>
</a>
            </div>
        </div>
    </div>
